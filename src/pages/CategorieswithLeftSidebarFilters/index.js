...
const CategorieswithLeftSidebarFiltersPage = () => {
  return (
    <>
      <Column
      ...
      >
        ...
        >
          ...
          <Row
            className="items-center justify-start lg:mt-[28px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] mt-[48px] xl:mx-[106px] 2xl:mx-[120px] 3xl:mx-[144px] mx-[160px] lg:mx-[93px] w-[12%]"
            compId="1063:209"
            comWidth={224}
            comHeight={27}
            compLeft={160}
          ...
          >
            ...
            >
              <Column
                className="border border-gray_500 border-solid items-start lg:mb-[136px] xl:mb-[156px] 2xl:mb-[175px] 3xl:mb-[210px] mb-[234px] xl:ml-[106px] 2xl:ml-[120px] 3xl:ml-[144px] ml-[160px] lg:ml-[93px] lg:mt-[132px] xl:mt-[151px] 2xl:mt-[170px] 3xl:mt-[204px] mt-[227px] lg:py-[18px] xl:py-[21px] 2xl:py-[24px] 3xl:py-[28px] py-[32px] rounded-radius16 w-[20%]"
                compId="828"
                comWidth={376}
                comHeight={1881}
                compLeft={160}
              ...
              >
                <Text
                  className="font-bold font-montserrat lg:mx-[126px] xl:mx-[144px] 2xl:mx-[162px] 3xl:mx-[195px] mx-[217px] lg:text-fs28 xl:text-fs32 2xl:text-fs36 3xl:text-fs43 text-fs48 text-gray_800 text-left w-[29%]"
                  compId="684:251"
                  comWidth={350}
                  comHeight={59}
                  compLeft={217}
                ...
                >
                  <Grid
                    className="lg:gap-[21px] xl:gap-[24px] 2xl:gap-[27px] 3xl:gap-[32px] gap-[36px] grid grid-cols-4 w-[100%]"
                    compId="866"
                    comWidth={1192}
                    comHeight={492}
                    compLeft={0}
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <Text
                        className="font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] not-italic text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_800 w-[66%]"
                        compId="1069:1019"
                        comWidth={178}
                        comHeight={27}
                        compLeft={10}
                    ...
                    >
                      ...
                      />
                      <Text
                        className="font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] not-italic text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_800 w-[53%]"
                        compId="1069:1024"
                        comWidth={144}
                        comHeight={27}
                        compLeft={10}
                    ...
                    >
                      ...
                      />
                      <Text
                        className="font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] not-italic text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_800 w-[28%]"
                        compId="1069:1031"
                        comWidth={75}
                        comHeight={27}
                        compLeft={10}
                    ...
                    >
                      ...
                      />
                      <Text
                        className="font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] not-italic text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_800 w-[52%]"
                        compId="1069:1046"
                        comWidth={141}
                        comHeight={27}
                        compLeft={10}
                    ...
                    >
                      ...
                      />
                      <Text
                        className="font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] not-italic text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_800 w-[55%]"
                        compId="1069:1051"
                        comWidth={150}
                        comHeight={27}
                        compLeft={10}
                    ...
                    >
                      ...
                      />
                      <Text
                        className="font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] not-italic text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_800 w-[44%]"
                        compId="1069:1061"
                        comWidth={119}
                        comHeight={27}
                        compLeft={10}
                    ...
                    >
                      ...
                      />
                      <Text
                        className="font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] not-italic text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_800 w-[67%]"
                        compId="1069:1036"
                        comWidth={182}
                        comHeight={27}
                        compLeft={10}
                    ...
                    >
                      ...
                      />
                      <Text
                        className="font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] not-italic text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_800 w-[27%]"
                        compId="1069:1041"
                        comWidth={73}
                        comHeight={27}
                        compLeft={10}
                    ...
                    >
                      ...
                      />
                      <Text
                        className="font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] not-italic text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_800 w-[40%]"
                        compId="1069:1066"
                        comWidth={108}
                        comHeight={27}
                        compLeft={10}
                    ...
                    >
                      ...
                      />
                      <Text
                        className="font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] not-italic text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_800 w-[19%]"
                        compId="1069:1071"
                        comWidth={51}
                        comHeight={27}
                        compLeft={10}
                ...
                <Text
                  className="font-bold font-montserrat mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[46px] xl:mt-[53px] 2xl:mt-[60px] 3xl:mt-[72px] mt-[80px] lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-gray_800 text-left w-[17%]"
                  compId="687:404"
                  comWidth={197}
                  comHeight={29}
                  compLeft={0}
                ...
                >
                  ...
                  >
                    <Text
                      className="font-normal font-playfairdisplay lg:ml-[1px] 3xl:ml-[2px] 2xl:ml-[2px] xl:ml-[2px] ml-[3px] 2xl:my-[2px] xl:my-[2px] lg:my-[2px] my-[3.5px] 3xl:my-[3px] not-italic lg:text-fs23 xl:text-fs26 2xl:text-fs30 3xl:text-fs36 text-fs40 text-gray_800 text-left w-[13%]"
                      compId="1066:633"
                      comWidth={158}
                      comHeight={53}
                      compLeft={3}
                    ...
                    >{`SimSong`}</Text>
                    <Text
                      className="font-medium font-poppins lg:text-fs23 xl:text-fs26 2xl:text-fs30 3xl:text-fs36 text-fs40 text-gray_800 text-left w-[10%]"
                      compId="1066:634"
                      comWidth={120}
                      comHeight={60}
                      compLeft={0}
                    ...
                    >{`Harps`}</Text>
                    <Text
                      className="font-normal font-vidaloka xl:my-[3px] lg:my-[3px] 3xl:my-[4px] 2xl:my-[4px] my-[5.5px] not-italic lg:text-fs23 xl:text-fs26 2xl:text-fs30 3xl:text-fs36 text-fs40 text-gray_800 text-left w-[12%]"
                      compId="1066:635"
                      comWidth={141}
                      comHeight={49}
                      compLeft={0}
                    ...
                    >{`DiskVan`}</Text>
                    <Text
                      className="font-bold font-montserrat xl:my-[3px] lg:my-[3px] 3xl:my-[4px] 2xl:my-[4px] my-[5.5px] lg:text-fs23 xl:text-fs26 2xl:text-fs30 3xl:text-fs36 text-fs40 text-gray_800 text-left w-[8%]"
                      compId="1066:636"
                      comWidth={93}
                      comHeight={49}
                      compLeft={0}
                    ...
                    >{`Ikon`}</Text>
                    <Text
                      className="font-bold font-nunito 2xl:my-[1px] xl:my-[1px] lg:my-[1px] my-[2.5px] 3xl:my-[2px] lg:text-fs23 xl:text-fs26 2xl:text-fs30 3xl:text-fs36 text-fs40 text-gray_800 text-left w-[10%]"
                      compId="1066:637"
                      comWidth={121}
                      comHeight={55}
                      compLeft={0}
                    ...
                    >{`Strons`}</Text>
                    <Text
                      className="font-bold font-inter lg:mr-[1px] 3xl:mr-[2px] 2xl:mr-[2px] xl:mr-[2px] mr-[3px] lg:my-[3px] 2xl:my-[4px] xl:my-[4px] 3xl:my-[5px] my-[6px] lg:text-fs23 xl:text-fs26 2xl:text-fs30 3xl:text-fs36 text-fs40 text-gray_800 text-left w-[13%]"
                      compId="1066:638"
                      comWidth={153}
                      comHeight={48}
                      compLeft={0}
                  ...
                  >
                    ...
                    >
                      <Text
                        className="font-bold font-montserrat mb-[11px] lg:mb-[6px] xl:mb-[7px] 2xl:mb-[8px] 3xl:mb-[9px] lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-gray_800 text-left w-[13%]"
                        compId="1066:642"
                        comWidth={153}
                        comHeight={29}
                        compLeft={0}
                      ...
                      >{`Product List`}</Text>
                      <Text
                        className="font-normal font-poppins mr-[1px] xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] not-italic text-deep_orange_400 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left w-[8%]"
                        compId="1066:643"
                        comWidth={92}
                        comHeight={36}
                        compLeft={0}
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <Column
                            className="items-center justify-start lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] mx-[auto] w-[61%]"
                            compId="1066:651"
                            comWidth={191}
                            comHeight={76}
                            compLeft={10}
                          ...
                          >
                            ...
                            >{`Smartphone 5G`}</Text>
                            <Text
                              className="font-medium mx-[auto] text-deep_orange_400 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left w-[56%]"
                              compId="1066:653"
                              comWidth={107}
                              comHeight={36}
                              compLeft={10}
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <Column
                            className="items-center justify-start ml-[10px] 2xl:ml-[7px] 3xl:ml-[9px] 2xl:mr-[6px] 3xl:mr-[8px] mr-[9px] lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] lg:mx-[5px] xl:mx-[6px] w-[94%]"
                            compId="1066:739"
                            comWidth={293}
                            comHeight={76}
                            compLeft={10}
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <Column
                            className="items-center justify-start lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] mx-[auto] w-[71%]"
                            compId="1066:761"
                            comWidth={222}
                            comHeight={76}
                            compLeft={10}
...
export default CategorieswithLeftSidebarFiltersPage;
